...
void auto_skills()
{
    ...
    skillscore();
    jeminloadert();
    moveForSec(30, false, 0.9); //FOURTH SCORE DONE
    setintakespd(-60);
    setintake2spd(-60);
    moveForSec(30, false, 0.9);
...
void Left_4ball()
{
    ...
    pidGyro(32.5, -123, 2, 100, 1, 25, 5, 20);
    jeminloadert();
    ...
    pidGyro(15, 135, 2, 100, 1, 25, 2, 15, 1.5);
    score_on = false;
    jeminwing.set_value(false);
    pros::delay(1);
    pidGyro(0, 178, 0.9, 100, 1, 25, 1, 15, 1.5);
    pidmove(-32, 1, 2);
    setintakespd(0);
    setintake2spd(0);
}
...
void Right_3_4()
{
    ...
    pidGyro(23, 290, 2, 100, 1, 25, 5, 70);
    jeminloadert();
    moveForSec(30, true, 0.3);
...
void Left_3_4()
{
    ...
    pidGyro(34.5, -129, 2, 100, 1, 25, 5, 20);
    ...
    setintakespd(-100);
    setintake2spd(0);
    pidGyro(34, 180, 2, 100, 1, 25, 1);
    moveForSec(55, true, 0.4);

    pidmove(-14, 1, 0.5, 100);
    pidGyro(-47, 230, 2, 100, 10);
    setintakespd(50);
    setintake2spd(0);
    moveForSec(40, false, 0.5);
    ...
    pidGyro(28, 280, 2, 100, 1, 25, 1, 1000);
...
void SAWP()
{
    ...
    pidGyro(23, 290, 2, 100, 5, 50, 1, 70);
    jeminloadert();
    ...
    storing = true;
    jeminmech.set_value(false);
    pidGyro(-60, 230, 2, 100, 10, 25, 1, 60);
    jeminmech.set_value(true);
    setintakespd(50);
    setintake2spd(0);
...
void right_7()
{
    ...
    pidTurnAbs(125, 10, 2);
    jeminloadert();
    pidGyro(34, 125, 2, 100, 1, 25, 5);

    pidTurnAbs(180, 5, 0.8);

    jeminloadert();
    pidGyro(20, 180, 1, 100, 1, 25, 1);
    moveForSec(30, true, 0.8);
