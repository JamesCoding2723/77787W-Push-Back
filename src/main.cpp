...
{   
    ...
    */
    ...
    pidMoveold(6, 1, 1, 100);
    pidTurnRel(93, 1, 1.2, 100);
    pidGyro(23, 290, 2, 100, 10);
    //jeminloadert();
    jeminmecht();

    //pros::delay(1000);
    pidGyro(59, 270, 4, 100, 1, 25, 10);
    //jeminloadert();
    //pros::delay(1000);
    //pidMoveold(6, 2, 1,80);

    pidTurnAbs(225, 1, 0.5);
    pidMoveold(-24, 0.5, 1, 100);
