...
{   
    ...
    pidMoveold(-4.5, 0.5, 2, 50);

    jeminloadert();
    pidTurnRel(-115, 2, 3, 60);
    //pros::delay(200);
    setintakespddiff(-100, 0);
    setintake2spd(0);
   ...
   //jeminmecht();
    ...
    pros::delay(100);
    //setintakespd(100);
    pidGyro(35, 285, 2, 70, 1, 25, 10, 10000);
    //pros::delay(1000);
    ...
    pidGyro(38, 225, 3, 70, 1, 25, 10, 100);
    pidTurnAbs(0, 1, 1);
    //pros::delay(1000);
    pidGyro(-25, 0, 2.4);
    setintakespd(-100);
    ...
    pidGyro(97, 180, 7, 70, 1, 25, 10, 100);
    //pros::delay(200);
